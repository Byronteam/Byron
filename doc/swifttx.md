...
This mechanism has been integrated into Bitcore-Node-BYRON which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/BYRON-Project/insight-api-byron#web-socket-api](https://github.com/BYRON-Project/insight-api-byron#web-socket-api) 
* API: [https://github.com/BYRON-Project/insight-api-byron#swifttx-transactions](https://github.com/BYRON-Project/insight-api-byron#swifttx-transactions) 
...
By default, the Byron Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Byron Core daemon:
