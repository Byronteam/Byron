...
#   c) node1 mines 32 blocks, so now node 0 has 60001byron, node 1 has 4250byron, node2 has none.
#   d) node0 sends 601 byron to node2, in two transactions (301 byron, then 300 byron).
