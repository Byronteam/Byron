/* src/config/byron-config.h.  Generated from byron-config.h.in by configure.  */
/* src/config/byron-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "byron.org"
