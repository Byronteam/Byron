...
"(default: %s)"),
QT_TRANSLATE_NOOP("byron-core", ""
"Fees (in BYRON/Kb) smaller than this are considered zero fee for transaction "
"creation (default: %s)"),
QT_TRANSLATE_NOOP("byron-core", ""
...
"your clock is wrong Byron Core will not work properly."),
QT_TRANSLATE_NOOP("byron-core", ""
...
QT_TRANSLATE_NOOP("byron-core", "(27215 could be used only on mainnet)"),
QT_TRANSLATE_NOOP("byron-core", "(default: %s)"),
QT_TRANSLATE_NOOP("byron-core", "(default: 1)"),
QT_TRANSLATE_NOOP("byron-core", "(must be 27215 for mainnet)"),
QT_TRANSLATE_NOOP("byron-core", "<category> can be:"),
...
QT_TRANSLATE_NOOP("byron-core", "Connect to a node to retrieve peer addresses, and disconnect"),
...
QT_TRANSLATE_NOOP("byron-core", "Disable OS notifications for incoming transactions (default: %u)"),
QT_TRANSLATE_NOOP("byron-core", "Disable safemode, override a real safe mode event (default: %u)"),
QT_TRANSLATE_NOOP("byron-core", "Discover own IP address (default: 1 when listening and no -externalip)"),
QT_TRANSLATE_NOOP("byron-core", "Display the stake modifier calculations in the debug.log file."),
QT_TRANSLATE_NOOP("byron-core", "Display verbose coin stake messages in the debug.log file."),
QT_TRANSLATE_NOOP("byron-core", "Do not load the wallet and disable wallet RPC calls"),
...
QT_TRANSLATE_NOOP("byron-core", "Entries are full."),
QT_TRANSLATE_NOOP("byron-core", "Error connecting to Masternode."),
QT_TRANSLATE_NOOP("byron-core", "Error initializing block database"),
QT_TRANSLATE_NOOP("byron-core", "Error initializing wallet database environment %s!"),
QT_TRANSLATE_NOOP("byron-core", "Error loading block database"),
QT_TRANSLATE_NOOP("byron-core", "Error loading wallet.dat"),
QT_TRANSLATE_NOOP("byron-core", "Error loading wallet.dat: Wallet corrupted"),
QT_TRANSLATE_NOOP("byron-core", "Error loading wallet.dat: Wallet requires newer version of Byron Core"),
...
QT_TRANSLATE_NOOP("byron-core", "Found enough users, signing ( waiting %s )"),
QT_TRANSLATE_NOOP("byron-core", "Found enough users, signing ..."),
QT_TRANSLATE_NOOP("byron-core", "Generate coins (default: %u)"),
QT_TRANSLATE_NOOP("byron-core", "How many blocks to check at startup (default: %u, 0 = all)"),
QT_TRANSLATE_NOOP("byron-core", "If <category> is not supplied, output all debugging information."),
QT_TRANSLATE_NOOP("byron-core", "Importing..."),
QT_TRANSLATE_NOOP("byron-core", "Imports blocks from external blk000??.dat file"),
QT_TRANSLATE_NOOP("byron-core", "Include IP addresses in debug output (default: %u)"),
QT_TRANSLATE_NOOP("byron-core", "Incompatible mode."),
QT_TRANSLATE_NOOP("byron-core", "Incompatible version."),
QT_TRANSLATE_NOOP("byron-core", "Incorrect or no genesis block found. Wrong datadir for network?"),
QT_TRANSLATE_NOOP("byron-core", "Information"),
QT_TRANSLATE_NOOP("byron-core", "Initialization sanity check failed. Byron Core is shutting down."),
QT_TRANSLATE_NOOP("byron-core", "Input is not valid."),
...
QT_TRANSLATE_NOOP("byron-core", "Invalid amount for -paytxfee=<amount>: '%s' (must be at least %s)"),
QT_TRANSLATE_NOOP("byron-core", "Invalid amount for -paytxfee=<amount>: '%s'"),
QT_TRANSLATE_NOOP("byron-core", "Invalid amount for -reservebalance=<amount>"),
QT_TRANSLATE_NOOP("byron-core", "Invalid amount"),
QT_TRANSLATE_NOOP("byron-core", "Invalid masternodeprivkey. Please see documenation."),
QT_TRANSLATE_NOOP("byron-core", "Invalid netmask specified in -whitelist: '%s'"),
QT_TRANSLATE_NOOP("byron-core", "Invalid port detected in masternode.conf"),
...
QT_TRANSLATE_NOOP("byron-core", "Listen for connections on <port> (default: %u or testnet: %u)"),
QT_TRANSLATE_NOOP("byron-core", "Loading addresses..."),
QT_TRANSLATE_NOOP("byron-core", "Loading block index..."),
QT_TRANSLATE_NOOP("byron-core", "Loading budget cache..."),
QT_TRANSLATE_NOOP("byron-core", "Loading masternode cache..."),
QT_TRANSLATE_NOOP("byron-core", "Loading masternode payment cache..."),
...
QT_TRANSLATE_NOOP("byron-core", "Set external address:port to get to this masternode (example: %s)"),
QT_TRANSLATE_NOOP("byron-core", "Set key pool size to <n> (default: %u)"),
QT_TRANSLATE_NOOP("byron-core", "Set maximum block size in bytes (default: %d)"),
QT_TRANSLATE_NOOP("byron-core", "Set minimum block size in bytes (default: %u)"),
QT_TRANSLATE_NOOP("byron-core", "Set the Maximum reorg depth (default: %u)"),
QT_TRANSLATE_NOOP("byron-core", "Set the masternode private key"),
QT_TRANSLATE_NOOP("byron-core", "Set the number of threads to service RPC calls (default: %d)"),
QT_TRANSLATE_NOOP("byron-core", "Sets the DB_PRIVATE flag in the wallet db environment (default: %u)"),
QT_TRANSLATE_NOOP("byron-core", "Show all debugging options (usage: --help -help-debug)"),
QT_TRANSLATE_NOOP("byron-core", "Shrink debug.log file on client startup (default: 1 when no -debug)"),
QT_TRANSLATE_NOOP("byron-core", "Signing failed."),
QT_TRANSLATE_NOOP("byron-core", "Signing timed out."),
QT_TRANSLATE_NOOP("byron-core", "Signing transaction failed"),
QT_TRANSLATE_NOOP("byron-core", "Specify configuration file (default: %s)"),
QT_TRANSLATE_NOOP("byron-core", "Specify connection timeout in milliseconds (minimum: 1, default: %d)"),
QT_TRANSLATE_NOOP("byron-core", "Specify data directory"),
QT_TRANSLATE_NOOP("byron-core", "Specify masternode configuration file (default: %s)"),
...
QT_TRANSLATE_NOOP("byron-core", "Synchronizing budgets..."),
...
QT_TRANSLATE_NOOP("byron-core", "Transaction fees are too high."),
QT_TRANSLATE_NOOP("byron-core", "Transaction not valid."),
...
QT_TRANSLATE_NOOP("byron-core", "Wallet is locked."),
QT_TRANSLATE_NOOP("byron-core", "Wallet needed to be rewritten: restart Byron Core to complete"),
QT_TRANSLATE_NOOP("byron-core", "Wallet options:"),
QT_TRANSLATE_NOOP("byron-core", "Wallet window title"),
QT_TRANSLATE_NOOP("byron-core", "Warning"),
QT_TRANSLATE_NOOP("byron-core", "Warning: This version is obsolete, upgrade required!"),
QT_TRANSLATE_NOOP("byron-core", "Warning: Unsupported argument -benchmark ignored, use -debug=bench."),
QT_TRANSLATE_NOOP("byron-core", "Warning: Unsupported argument -debugnet ignored, use -debug=net."),
QT_TRANSLATE_NOOP("byron-core", "Will retry..."),
QT_TRANSLATE_NOOP("byron-core", "You need to rebuild the database using -reindex to change -txindex"),
QT_TRANSLATE_NOOP("byron-core", "Your entries added successfully."),
