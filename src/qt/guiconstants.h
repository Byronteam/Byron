...
/* Byron GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "BYRON"
#define QAPP_ORG_DOMAIN "byron.org"
#define QAPP_APP_NAME_DEFAULT "Byron-Core"
#define QAPP_APP_NAME_TESTNET "Byron-Core-testnet"
