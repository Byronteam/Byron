...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "byron.conf"));
    ...
    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    for (boost::program_options::detail::config_file_iterator it(streamConfig, setOptions), end; it != end; ++it) {
        // Don't overwrite existing settings so command line settings override byron.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "byrond.pid"));
